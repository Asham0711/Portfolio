  ...
  return (
    <div name="Education" className='max-w-screen-2xl container mx-auto px-4 md:px-20 my-20'>
        ...
        <div className='space-y-5'>
            <ul className='border-2 border-green-500 rounded-xl px-2 py-8 md:px-16 md:py-10 md:m-20'>
                <li className='flex justify-between'>
                    <div>
                        ...
                        <h1 className='font-bold md:text-xl flex justify-between items-center gap-3'>
                            <FaSchool className='text-green-500 hidden md:block'/>
                    ...
                    <div>
                        ...
                        <p className='flex md:justify-center items-center gap-3'>
                            <SlCalender className='text-green-500 hidden md:block' /> 2021-2025
                        </p>
                    </div>
                </li>
                <br />
                <li className='flex justify-between'>
                    <div>
                        ...
                        <h1 className='font-bold md:text-xl flex justify-between items-center gap-3'>
                            <FaSchool className='text-green-500 hidden md:block' />GR KC Mills High School
                        </h1>
                    </div>
                    <div>
                        <h1 className='md:text-xl flex justify-between items-center gap-3'>
                        ...
                        <p className='flex md:justify-center items-center gap-3'>
                            <SlCalender className='text-green-500 hidden md:block' /> 2018-2020
                        </p>
                    </div>
                </li>
                <br />
                <li className='flex justify-between'>
                    <div>
                        ...
                        <h1 className='font-bold md:text-xl flex justify-between items-center gap-3'>
                            <FaSchool className='text-green-500 hidden md:block' />St. Michaels Academy
                        </h1>
                    </div>
                    <div>
                        <h1 className='md:text-xl flex justify-between items-center gap-3'>
